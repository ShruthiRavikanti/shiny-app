...
setwd("C:/Users/Lenovo/Desktop/data science/shiny/reactive")
library(shiny)
...
shinyUI(fluidPage(
  ...
  sidebarPanel(
    ...
    radioButtons("colour","3. Select the color of histogram",choices = c("Green", "Skyblue", "Orange"), selected = "Orange")
  ),
